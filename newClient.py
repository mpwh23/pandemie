...
# UI
    ...
    def window_00_load_async(self):
        ...
        self.img_c2_raw = Image.open(res_path + "cards/c2_0.png")
            ...
            while True:
                ...
                for key, mask in events:
                    ...
                    try:
                        ...
                        if mask == 1:
                            # update = self.game_engine(message.get_response(), message.getVersion())
...
# game
    def game_engine(self, m_response):
        ...
        if self.game_STATE == "SUPPLY" and len(self.this_player_drawcards) == 0:
            self.dismiss_tooltip()
            self.txt_action = ""
            self.txt_status = "Infectionsphase"
...
# main game
    ...
    def receive_card(self, *args):
        ...
        if len(self.this_player_drawcards) > 0:
            if self.this_player_drawcards[0] != 54:
